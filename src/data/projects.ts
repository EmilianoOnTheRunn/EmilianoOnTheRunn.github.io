...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: "Product definition, campaign contract, planner abstraction, private ranking boundary, CLI, tests, and documentation.",
  ...
  },
  {
    ...
    role: "Workflow design, private policy boundaries, local-model evidence summaries, upstream runtime evaluation, and safety controls.",
    technologies: [
      "Python",
      "Ollama",
